...
public class Archivo {
    ...
    public static void EnviarArchivo(XMPPConnection pConnection, String pIdUsuario, String pArchivo, String pDescripcion)
    {
        FileTransferManager manager = new FileTransferManager(pConnection);
        OutgoingFileTransfer transfer = manager.createOutgoingFileTransfer(pIdUsuario + "/Smack");
    ...
    public static void RecibirArchivo(XMPPConnection pConnection)
    {
        FileTransferManager manager = new FileTransferManager(pConnection);
